"""
Code from https://github.com/huanranchen/AdversarialAttacks/blob/main/data/NIPS17.py
"""
...
class NIPS17(Dataset):
    def __init__(self, images_path='./resources/NIPS17/images/',
        ...
        # PDF_DIR = (here / ".." / "data" / "pdfs").resolve()
        images_path = (here /".." / ".." / "data" / "datasets" / "nips17" / "images").resolve()
        label_path = (here /".." / ".." / "data" / "datasets" / "nips17" / "images.csv").resolve()
